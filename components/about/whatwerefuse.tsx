    ...
    >
      ...
      <div className="relative ">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-4 relative">
          ...
          >
            <h3 className="text-2xl sm:text-3xl md:text-[2.5rem] font-bold text-white mb-2 sm:mb-3 text-center">
              {leftPillar.title}
            </h3>
          ...
          <div className="relative flex items-center justify-center order-1 lg:order-2 shrink-0">
            ...
            <div className="relative w-[290px] h-[290px] sm:w-[380px] sm:h-[380px] md:w-[440px] md:h-[440px] flex items-center justify-center">
              ...
              {/* Continuously Rotating Orbit Layer with Traveling Particles */}
              <motion.div
                animate={{ rotate: 360 }}
                transition={{
                  repeat: Infinity,
              ...
              >
                ...
                <div className="absolute -top-[5px] left-1/2 -translate-x-1/2 flex items-center justify-center">
                  ...
                  <div className="absolute w-5 h-5 rounded-full bg-cyan-400/20 animate-ping" />
                </div>

                {/* Orbiting Satellite 2 (Diagonal) */}
                <div className="absolute top-[75%] left-[93%] -translate-x-1/2 -translate-y-1/2">
                  <div className="w-2 h-2 rounded-full bg-blue-400/80 shadow-[0_0_8px_#60a5fa]" />
                </div>

                {/* Orbiting Satellite 3 (Opposite Diagonal) */}
                <div className="absolute top-[25%] left-[7%] -translate-x-1/2 -translate-y-1/2">
                  <div className="w-1.5 h-1.5 rounded-full bg-sky-300/70 shadow-[0_0_6px_#7dd3fc]" />
                </div>
              </motion.div>
              ...
              {/* Fixed Cardinal Anchor Dots (Matching Design Mockup) */}
              ...
              <div className="absolute left-0 top-1/2 -translate-x-1/2 -translate-y-1/2 z-20 flex items-center justify-center">
                <div className="w-3 h-3 sm:w-3.5 sm:h-3.5 rounded-full bg-[#38bdf8] shadow-[0_0_12px_#38bdf8]" />
                <div className="absolute w-6 h-6 rounded-full bg-sky-400/20 animate-pulse" />
              </div>
              ...
              {/* Bottom Point (6 o'clock) with Concentric Indicator Ring */}
              <div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 z-20 flex items-center justify-center">
                <div className="w-4 h-4 sm:w-5 sm:h-5 rounded-full border-2 border-sky-400 flex items-center justify-center bg-[#0d1424]">
                  <div className="w-2 h-2 sm:w-2.5 sm:h-2.5 rounded-full bg-[#38bdf8] shadow-[0_0_10px_#38bdf8]" />
                </div>
              </div>
          ...
          >
            <h3 className="text-2xl sm:text-3xl md:text-[2.5rem] text-center font-bold text-white mb-2 sm:mb-3">
              {rightPillar.title}
            </h3>
        ...
        >
          <h3
            ...
            style={{ color: bottomPillar.titleColor }}
          >
            {bottomPillar.title}
          </h3>
